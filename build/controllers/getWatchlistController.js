...
exports.getWatchlistController = void 0;
 ...
 * @returns
 */
function getWatchlistController(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, apiService_1.getWatchlistInfo)()];
                case 1:
                    result = _a.sent();
                ...
                case 2:
                    ...
                    if (error_1.status) {
                        ...
                        return [2 /*return*/, res.status(error_1.status).send(errorMessage)];
                    }
                    else if (error_1.isAxiosError && error_1.response && error_1.response.status) {
...
//# sourceMappingURL=getWatchlistController.js.map