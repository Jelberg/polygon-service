...
router.get('/stock/:ticker/quote', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var ticker, date, currentDate, formatDate, response, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                return [4 /*yield*/, axios_1.default.get("https://api.polygon.io/v2/aggs/ticker/".concat(ticker.toUpperCase(), "/range/1/minute/").concat(formatDate, "/").concat(formatDate, "?adjusted=true&sort=desc&limit=10&apiKey=").concat(apiKey))];
            case 1:
                response = _a.sent();
                res.json(response.data);
                return [3 /*break*/, 3];
...
router.get('/stock/:ticker/all', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var ticker, date, currentDate, formatDate, quote, company, error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
